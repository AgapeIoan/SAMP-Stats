...
devs = [318348903114211328, 86477779717066752] # Daaaa, stiu ca e hardcoded dar lasa, low effort go brrrrr

def is_developer(ctx):
    """ Checks if the author is a developer """ # Facut pentru comanda de `amiadmin`
